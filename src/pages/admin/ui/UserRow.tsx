...
export function UserRow({
  ...
  return (
    <tr className={statusKey !== 'active' ? 'ap__row--dim' : ''}>
      <td>
      ...
      <td><span className={`ap__status-badge ap__status-badge--${statusKey}`}>{statusLabel}</span></td>
      <td className="ap__td-date">{formatDateOnly(u.created_at)}</td>
      <td className="ap__td-date">{formatDateOnly(u.updated_at)}</td>
      <td>
